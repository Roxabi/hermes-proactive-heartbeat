...
7. Optionally set `TYPESAFE_API_KEY` in `$HERMES_HOME/.env`. Direct `ActionSpec` rules never use TypeSafe; semantic `JudgmentSpec` decisions use their configured fallback without it.
